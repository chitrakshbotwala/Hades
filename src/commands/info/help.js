  ...
  run(message, args) {
    ...
    if (
      ...
      embed // Build help embed
        ...
        .setTimestamp()
        .setImage('https://images-ext-2.discordapp.net/external/e8tIQ1_uVlmvlsUBilaphdctMiZUlyJNR277Q5bfynw/https/cdn.discordapp.com/icons/587516620671287321/25e456f64708af2dc7561a22d4a12767.webp')
        .setColor(message.guild.me.displayHexColor);
