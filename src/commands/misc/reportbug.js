...
module.exports = class ReportBugCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        Sends a message to the HADES Support Server's bug report channel.
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [HADES Support Server](https://discord.gg/BrKpRM5r) to further discuss your issue.
        Additionally, feel free to contact us anytime !
      `) 
